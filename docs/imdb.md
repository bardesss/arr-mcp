...
Measured against the live dumps on 2026-08-23:
...
sorting every candidate — and it costs no extra disk, because the separate
ratings table and its index went away in exchange.
...
no live install ever reached it.
